...
def migrate():
    ...
    try:
        ...
        if not column_exists("orders", "return_image_url"):
            cursor.execute("ALTER TABLE orders ADD COLUMN return_image_url VARCHAR(255) DEFAULT NULL")
            print("Added return_image_url to orders")
